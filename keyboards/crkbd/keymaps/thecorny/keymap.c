...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LT(_NUMPAD,KC_TAB), 	KC_Q, 	 KC_W, 	  KC_F,    KC_P,    KC_B,    	      		  KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN, KC_BSPC,
	...
	//|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
				  KC_LGUI,MO(_NUM),LALT_T(KC_SPC),      LT(_DEBUG,KC_SPC),MO(_SYM), KC_RALT
					    //`--------------------------'  `--------------------------'
	),
 ...
 LT(_NUMPAD,KC_TAB), 	KC_Q, 	 KC_W, 	  KC_E,    KC_R,    KC_T,		 	  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSPC,
	...
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	    _______, G(S(C(KC_4))), KC_LSFT, KC_LALT, KC_LGUI, KC_LCTL, 		       KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX,  KC_DEL,
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	    _______, G(S(KC_3)), G(S(KC_4)), G(S(KC_5)), G(S(KC_M)), XXXXXXX,		       KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT, KC_MUTE, C(G(KC_Q)),
	//|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
	...
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 		         KC_F9,   KC_F8,   KC_F7,A(KC_F8),A(KC_F9),G(KC_F2),
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
